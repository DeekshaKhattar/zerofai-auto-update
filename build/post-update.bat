...
schtasks /create /sc daily /st 19:00 /tn "System Health Check Task 1.1" /tr "\"C:\Program Files\Python312\python.exe\" \"%INSTDIR%\resources\system_health.py\"" /ru SYSTEM /rl HIGHEST /f
